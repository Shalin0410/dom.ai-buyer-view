...
const ProgressTracker = ({ showDetailed = false }) => {
  ...
  const getStepIcon = (status, index) => {
    switch (status) {
      case 'completed':
        return (
          <div className="w-6 h-6 bg-green-500 rounded-full flex items-center justify-center text-white shadow-sm border-2 border-white relative z-10">
            <CheckCircle size={12} />
          </div>
        );
      case 'in_progress':
        return (
          <div className="w-6 h-6 bg-blue-500 rounded-full flex items-center justify-center text-white shadow-sm border-2 border-white relative z-10">
            <div className="w-2 h-2 bg-white rounded-full animate-pulse"></div>
          </div>
        );
      default:
        return (
          <div className="w-6 h-6 bg-gray-200 rounded-full flex items-center justify-center text-gray-500 shadow-sm border-2 border-white relative z-10">
      ...
      <Card className="bg-white shadow-sm">
        <CardContent className="p-6">
          ...
          <div className="relative">
            {/* Background Line */}
            <div className="absolute top-3 left-3 right-3 h-0.5 bg-gray-200 rounded-full"></div>
            
            {/* Progress Line */}
            <div 
              className="absolute top-3 left-3 h-0.5 bg-gradient-to-r from-green-500 via-blue-500 to-blue-400 rounded-full transition-all duration-1000 ease-out"
